...
public class BookService {
    ...
    public String addBook(BookRequestDto bookRequestDto){
        ...
        //We need to update the listOfBooks written in the parent cla
        ...
        //bookRepo.save is not required : because it will be autocalled by cascading
        //effect
